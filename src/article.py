class Article:
    ...
    def get_new_id(self) -> int:
        """
        Метод добавляет ID следующей статьи
        """
...
if __name__ == '__main__':
    new_articles_1 = Article.insert('test1', 'test1')
    print(new_articles_1.article_id)

    new_articles_2 = Article.insert('test2', 'test2')
    print(new_articles_2.article_id)
